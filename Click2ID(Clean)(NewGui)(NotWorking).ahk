...
Gui, Add, Text, x678 y2 w26 h18 0x40201 gMini,           ; __
Gui, Add, Text, x678 y2 w26 h18 0x41201 Hidden gMini,    ; __
Gui, Add, Text, x704 y2 w26 h18 0x40201 gMaxi,           ; []
Gui, Add, Text, x704 y2 w26 h18 0x41201 Hidden gMaxi,    ; []
Gui, Add, Text, x730 y2 w26 h18 0x40201 gClose,          ; X
Gui, Add, Text, x730 y2 w26 h18 0x41201 Hidden gClose,   ; X
Gui, Add, Text, x770 y2 w26 h18 gAbout 0x40201,          ; ?
Gui, Add, Text, x770 y2 w26 h18 gAbout Hidden 0x41201,   ; ?
...
Gui, Add, Picture, x21 y302 gSwitcher, c:\Users\Abel\Desktop\scripts\Click2ID\Text_Info.png
Gui, Add, Picture, x21 y302 Hidden gSwitcher, c:\Users\Abel\Desktop\scripts\Click2ID\Text_Clip.png
Gui, Add, GroupBox, x402 y308 w384 h48 , Actions
Gui, Add, Button, x410 y323 w72 h25 +Default gRecapture, Recapture
Gui, Add, Button, x483 y323 w72 h25 gCopyAllH, Copy history
Gui, Add, Button, x556 y323 w72 h25 gCopyAllW, Copy all Win
Gui, Add, Button, x629 y323 w72 h25 , Copy all Ctrl
Gui, Add, Button, x702 y323 w72 h25 , Save Clipb.
Gui, Add, GroupBox, x403 y358 w384 h53 , Tools
